    ...
    const fetchPriceHistory = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `/api/data/analytics/token-price-history?${params}`,
        );
        const result = await response.json();
...
export function useBalanceHistory(
  ...
  const fetchBalanceHistory = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/data/analytics/balance-history?${params}`,
      );
      const result = await response.json();
  ...
  useEffect(() => {
    const fetchTopChanges = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `/api/data/analytics/top-price-changes?${params}`,
        );
        const result = await response.json();
  ...
  useEffect(() => {
    ...
    const fetchTransactionHistory = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `/api/data/analytics/transaction-history?${params}`,
