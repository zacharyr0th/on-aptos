...
export const CACHE_TTL = {
  ...
  BTC_SUPPLY: 15 * 60 * 1000, // 15 minutes (increased from 10)
  LST_SUPPLY: 10 * 60 * 1000, // 10 minutes (increased from 5)
  STABLECOIN_SUPPLY: 15 * 60 * 1000, // 15 minutes (increased from 10)
  RWA_DATA: 30 * 60 * 1000, // 30 minutes (increased from 15)
  PRICE_DATA: 5 * 60 * 1000, // 5 minutes (increased from 2)
} as const;
