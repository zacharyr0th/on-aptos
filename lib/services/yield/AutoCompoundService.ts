...
export class AutoCompoundService {
  ...
  calculateOptimalCompoundFrequency(
    ...
    if (breakEvenDays < 1) {
      return { frequency: "daily", estimatedGain: dailyYield * 365 - gasCostUSD * 365 };
    } else if (breakEvenDays < 7) {
      return { frequency: "weekly", estimatedGain: dailyYield * 52 * 7 - gasCostUSD * 52 };
    } else if (breakEvenDays < 30) {
      return { frequency: "monthly", estimatedGain: dailyYield * 12 * 30 - gasCostUSD * 12 };
    } else {
