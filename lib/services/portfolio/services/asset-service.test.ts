...
vi.mock('../shared/unified-price-service', () => ({
  UnifiedPriceService: {
    getPricesForAssets: vi.fn(),
  },
}))

import { UnifiedPriceService } from '../shared/unified-price-service'
...
describe('Asset Service', () => {
  ...
  describe('getWalletAssets', () => {
    it('should fetch and merge fungible assets with token metadata', async () => {
      ...
      vi.mocked(UnifiedPriceService.getPricesForAssets).mockResolvedValue(mockPrices)
