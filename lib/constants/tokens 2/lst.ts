/**
 * Liquid Staking Token (LST) Definitions
 * Comprehensive mapping of liquid staking tokens and their derivatives
 */

/**
 * Basic liquid staking token addresses
 */
...
/**
 * Comprehensive LST Token Addresses - Both coin and FA versions
 */
...
/**
 * Known Bitcoin variant token addresses
 */
export const BTC_TOKENS = {
  // Bitcoin variants
  ceWBTC:
    '0x48271d39d0b05bd6efca2278f22277d6fcc375504f9839fd73f74ace240861af::coin::T',
  zBTC: '0x96ca72fc5d8df18ddad8cd887c3ce2ae32e1caa5bcd7f1efda1f072c0f0cfd37::coin::T',
} as const;
