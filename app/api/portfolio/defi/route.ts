...
export async function GET(request: NextRequest) {
  try {
    ...
    apiLogger.info(`[Portfolio DeFi API] Fetching DeFi positions for: ${walletAddress}`);
    ...
    apiLogger.info(`[Portfolio DeFi API] Found ${positions.length} DeFi positions`);
    ...
    apiLogger.error(`[Portfolio DeFi API] Error: ${error instanceof Error ? error.message : String(error)}`);
