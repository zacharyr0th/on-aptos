...
describe('GET /api/aptos/stables', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  it('should fetch stablecoin data on Aptos', async () => {
    ...
    const mockGraphQLResponse = {
      data: {
        fungible_asset_metadata: [
          {
            asset_type: '0xbae207659db88bea0cbead6da0ed00aac12edcdda169e591cd41c94180b46f3b',
            supply_v2: '500000000000000',
            decimals: 6,
          },
          {
            asset_type: '0x357b0b74bc833e95a115ad22604854d6b0fca151cecd94111770e5d6ffc9dc2b',
    ...
    const request = new Request('http://localhost:3000/api/aptos/stables')
