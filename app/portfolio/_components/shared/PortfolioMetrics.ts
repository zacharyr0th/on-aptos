...
// Re-export main types from consolidated types
export type { FungibleAsset, DeFiPosition, NFT, NFTCollectionStats };
...
// NFTCollectionStats imported from consolidated types
