...
import { NFTSummaryView } from "../shared/SummaryViews";
import { UnifiedNFTGrid } from "../shared/UnifiedNFTGrid";
import { AssetsTable, DeFiPositionsTable } from "../tables/PortfolioTables";
  ...
  return (
    <div className="lg:col-span-2 space-y-4 mt-4">
      ...
      <PortfolioTabs
        ...
        onTabChange={(tab) =>
          setSidebarView(tab as "portfolio" | "defi" | "nfts")
        }
        eyeToggle={
          setHideFilteredAssets
            ? {
