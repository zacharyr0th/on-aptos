...
interface DeFiTableProps extends BaseTableProps {
  groupedDeFiPositions: Array<Record<string, unknown>> | null;
...
export const AssetsTable = ({
  ...
  const renderAssetRow = (asset: unknown, showDivider = false) => (
...
export const DeFiPositionsTable = ({
  ...
  return (
    <div className="defi-table-container" data-defi-table>
      ...
      {isMobile ? (
        <div className="space-y-2">
          {sortedPositions.map((item, _index) => (
            <DeFiCard
