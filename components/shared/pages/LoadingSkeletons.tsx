...
import type { LoadingSkeletonProps } from "@/lib/types/ui";
...
interface AssetTableSkeletonProps extends Omit<LoadingSkeletonProps, "variant"> {
  rows?: number;
...
export const DeFiSummarySkeleton: React.FC<{ className?: string }> = ({ className = "" }) => (
...
// Full Portfolio Page Skeleton (from LoadingSkeleton.tsx)
...
// Simple Metrics Table Skeleton (from MetricsLoadingSkeleton.tsx)
...
export const MetricsTableSkeleton: React.FC<MetricsTableSkeletonProps> = ({
  rows = 10,
  columns = 5,
  className = "",
}) => {
...
export const LoadingSkeleton: React.FC<LocalLoadingSkeletonProps> = ({
  ...
  switch (variant) {
    ...
    case "full-portfolio-page":
      return <FullPortfolioPageSkeleton {...props} />;
    case "metrics-table":
      return <MetricsTableSkeleton className={className} {...props} />;
    default:
