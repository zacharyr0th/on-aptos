...
const ICON_MAP: Record<string, string> = {
  USDe: "/icons/stables/usde.webp",
  sUSDe: "/icons/stables/susde.webp",
  USDC: "/icons/stables/usdc.webp",
  USDt: "/icons/stables/usdt.webp",
} as const;
  ...
  const formattedAmount = useMemo(() => {
    return measurePerformance(() => {
      try {
        ...
        const tokenCount =
          Number(BigInt(rawSupply)) / Math.pow(10, metadata.decimals || 0);
...
export const TokenDialog = memo<TokenDialogProps>(
  ({ isOpen, onClose, symbol, metadata, supply, susdePrice, suppliesData = {} }) => {
