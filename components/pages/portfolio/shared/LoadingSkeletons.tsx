...
export const TransactionTableSkeleton: React.FC<{ rows?: number; className?: string }> = ({
  rows = 10,
  className = "",
}) => (
...
export const YieldTableSkeleton: React.FC<{ rows?: number; className?: string }> = ({
  rows = 10,
  className = "",
}) => (
  <div className={`space-y-6 ${className}`}>
...
interface LoadingSkeletonProps {
  variant: "nft-grid" | "asset-table" | "wallet-summary" | "chart" | "stats" | "defi-summary" | "transactions" | "yield-table" | "yield-opportunities";
  className?: string;
