...
import { sanitizeNFTMetadata, sanitizeImageUrl, sanitizeText, safeWindowOpen } from "@/lib/utils/security";
import { getTokenLogoUrlWithFallbackSync } from "@/lib/utils/token-utils";
                  ...
                  <div className="space-y-4 pr-4">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {sanitizedNFT.collection_name || "Unknown Collection"}
                      </p>
                            ...
                            <div className="space-y-4">
                              <div>
                                ...
                                <p className="font-medium">
                                  {sanitizedNFT.collection_name || "Unknown"}
                                </p>
                              </div>
                            ...
                            <div className="space-y-4">
                              ...
                              {selectedNFT.cdn_image_uri && (
                                <div>
                                  ...
                                  <button
                                    onClick={() => safeWindowOpen(selectedNFT.cdn_image_uri, "_blank")}
                              ...
                              {selectedNFT.cdn_animation_uri && (
                                <div>
                                  ...
                                  <button
                                    onClick={() => safeWindowOpen(selectedNFT.cdn_animation_uri, "_blank")}
                                    className="font-mono text-sm text-primary hover:underline break-all text-left"
                                  >
                                    {selectedNFT.cdn_animation_uri}
                                  </button>
                          ...
                          <AccordionContent>
                            <ScrollArea className="h-[200px]">
                              <pre className="bg-muted p-4 rounded-md overflow-x-auto text-sm">
                                ...
                                "string"
                                  ? sanitizeText(selectedNFT.token_properties)
