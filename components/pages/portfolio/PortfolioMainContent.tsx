  ...
  return (
    <div className="lg:col-span-3">
      <Tabs
        ...
        className="h-full"
      >
        <div className="w-full pb-3 hidden lg:block">
        ...
        <TabsContent value="portfolio" className="mt-2 p-0">
