    ...
    return (
      ...
      >
        <div className="aspect-square rounded-lg overflow-hidden border hover:border-primary transition-colors">
          {(() => {
            const rawImageUrl = nft.cdn_image_uri || nft.token_uri;
            if (!rawImageUrl) {
              return (
            ...
            const imageUrl = convertIPFSToHTTPSync(rawImageUrl);
              ...
              <div className="relative w-full h-full">
                <Image
                  ...
                  onError={(e) => {
                    ...
                    logger.debug(`NFT image failed to load: ${imageUrl}`);
                  }}
                />
              </div>
            );
