...
import { safeWindowOpen, sanitizeNFTMetadata, sanitizeImageUrl } from "@/lib/utils/security";
      ...
      <DialogContent className="w-[95%] max-w-[380px] sm:max-w-md h-[90vh] sm:h-auto sm:max-h-[85vh] mx-auto flex flex-col p-0 fixed top-[50vh] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        <DialogHeader className="p-4 pb-2 sm:p-6 sm:pb-2">
          <DialogTitle className="flex items-center gap-2 text-sm sm:text-base pr-8">
            ...
            <span className="truncate">{sanitizedNFT.token_name || "NFT"}</span>
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-4 sm:px-6 sm:pb-6">
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              {sanitizedNFT.description && sanitizedNFT.description.length < 100 && (
            ...
            <Button
              ...
              className="w-full"
              size="sm"
              onClick={() => safeWindowOpen(explorerUrl, "_blank")}
            >
