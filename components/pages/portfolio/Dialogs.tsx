...
interface NFTDetailsDialogProps extends NFTDialogProps {
  // nft property is inherited from NFTDialogProps
}

interface ProtocolDetailsDialogProps extends ProtocolDialogProps {
  // protocolName, protocolLogo, and defiPosition are inherited from ProtocolDialogProps
}
...
export const NFTDetailsDialog: React.FC<NFTDetailsDialogProps> = ({
  ...
  const copyTokenId = async () => {
    const success = await copyToClipboard(nft.token_data_id, "Token ID");
    if (success) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[95%] max-w-[380px] sm:max-w-md h-[90vh] sm:h-auto sm:max-h-[85vh] mx-auto flex flex-col p-0 fixed top-[50vh] left-[50%] translate-x-[-50%] translate-y-[-50%]">
...
export const ProtocolDetailsDialog: React.FC<ProtocolDetailsDialogProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[95%] max-w-[380px] sm:max-w-lg md:max-w-2xl max-h-[85vh] overflow-y-auto mx-auto fixed top-[50vh] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        <DialogHeader>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1 mt-1">
                    {Array.from(defiPosition.protocolTypes || []).map(
                      (type) => (
                        <Badge
                          key={String(type)}
                          variant="secondary"
