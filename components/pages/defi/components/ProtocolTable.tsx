        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent border-b-2">
              <TableHead className="font-bold text-base py-6 pl-6 pr-4 w-[40%]">
                {t("defi:table.protocol", "Protocol")}
              </TableHead>
              <TableHead className="font-bold text-base py-6 pl-2 pr-6 w-[20%]">
                {t("defi:table.category", "Category")}
              </TableHead>
              <TableHead className="font-bold text-base py-6 px-6 w-[25%]">
                {t("defi:table.subcategory", "Subcategory")}
              </TableHead>
              <TableHead className="font-bold text-base py-6 pr-8 pl-6 w-[15%]">
          ...
          <TableBody>
            {filteredProtocols.map((protocol, index) => {
              ...
              return (
                ...
                >
                  <TableCell className="py-4 md:py-6 pl-6 pr-4">
                  ...
                  <TableCell className="py-4 md:py-6 pl-2 pr-6 align-middle">
                  ...
                  <TableCell className="py-4 md:py-6 px-6 align-middle">
                  ...
                  <TableCell className="py-4 md:py-6 px-6 align-middle text-right">
