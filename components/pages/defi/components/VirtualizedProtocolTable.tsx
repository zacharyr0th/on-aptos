    ...
    return (
      <div className="space-y-4">
        <Table>
          ...
          <TableBody>
            {sortedProtocols.map((protocol, _index) => {
              ...
              const formatPercent = (
                ...
                return (
                  <span className={`font-mono ${positive ? color : ""}`}>
                    {val >= 0 ? "+" : ""}
                    {val.toFixed(2)}%
                  </span>
                );
              ...
              return (
                <React.Fragment key={protocol.title}>
                  <TableRow>
                          ...
                          {(protocol.title.toLowerCase().includes("pancake") ||
                            ...
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <span className="ml-1 text-xs text-primary align-super">
                                  ●
                                </span>
                              </TooltipTrigger>
                    ...
                    <TableCell className="min-w-[140px] sm:min-w-[160px] text-sm px-3">
                      <div className="space-y-1">
                        <div className="font-medium font-mono">
                          {formatNumber(
                            protocol.tvl?.defiLlama || protocol.tvl?.current,
                          )}
                        </div>
                    ...
                    {/* 24h Fees */}
                    <TableCell className="min-w-[120px] sm:min-w-[140px] text-sm hidden lg:table-cell px-3 font-mono">
