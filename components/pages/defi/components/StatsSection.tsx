    ...
    <div className="mb-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-6 mb-6">
        <StatCard
          ...
          change={
            tvlChange24h !== undefined
              ? { value: tvlChange24h, period: "1d" }
              : undefined
          }
          tooltip="Total value of all assets locked in DeFi protocols across the Aptos ecosystem"
          isLoading={isLoading}
          showError={!!showErrorState}
          icon={{ src: "/icons/dl.png", alt: "DeFiLlama" }}
        />
        ...
        <StatCard
          ...
          change={
            volumeChange24h !== undefined
              ? { value: volumeChange24h, period: "1d" }
              : undefined
          }
          tooltip="Total trading volume across all DeFi protocols in the last 24 hours"
          isLoading={isLoading}
          showError={!!showErrorState}
          icon={{ src: "/icons/dl.png", alt: "DeFiLlama" }}
        />
        ...
        <StatCard
          ...
          change={
            feesChange24h !== undefined
              ? { value: feesChange24h, period: "1d" }
              : undefined
          }
          tooltip="Total fees generated by all DeFi protocols in the last 24 hours"
          isLoading={isLoading}
          showError={!!showErrorState}
          icon={{ src: "/icons/dl.png", alt: "DeFiLlama" }}
        />
        ...
        <StatCard
          ...
          tooltip="Number of active DeFi protocols currently tracked on Aptos blockchain"
          isLoading={false}
          showError={false}
        />
      </div>
