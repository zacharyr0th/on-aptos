...
export const getSortedCategories = () => {
  ...
  const sorted = allCategories.sort((a, b) => {
    const aOrder =
      categoryDefinitions[a as keyof typeof categoryDefinitions]?.sortOrder ||
      999;
    const bOrder =
      categoryDefinitions[b as keyof typeof categoryDefinitions]?.sortOrder ||
      999;
...
export const getSortedSubcategories = (category: string) => {
  ...
  const sortOrder = categoryDef.subcategorySortOrder as
