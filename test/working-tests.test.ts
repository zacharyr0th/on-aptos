...
vi.mock('@/lib/services/stablecoin-service', () => ({
  StablecoinService: {
...
describe('Working API Tests', () => {
  ...
  describe('Utility Functions', () => {
    ...
    it('should handle cache operations', async () => {
      const { EnhancedLRUCache } = await import('@/lib/utils/cache-manager')
      const cache = new EnhancedLRUCache<string>(100, 60000) // 100 max size, 60s TTL
